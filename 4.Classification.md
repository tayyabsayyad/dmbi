...
Bagging is an embesel method used to determine the accuraccy.
It is a combination of boosting and aggregation.
In each iteration the data set D Is sampled using boosting and a model is made tl learn on that sampled data set.
